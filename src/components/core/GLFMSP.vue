    ...
    <v-row justify="center" class="mx-1">
      <v-col cols="6">
        <v-card class="ma-3 mb-0" height="200">
          ...
          <v-card-text>
            <b>Great Lakes Fish Monitoring and Surveillance Program (GLFMSP)</b>
            is a long term monitoring program supported by U.S. EPA. It was
            ...
            identifying emerging contaminants that may pose a risk to the Great
            Lakes.
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="6">
        <v-card class="ma-3 mb-0" height="200">
          ...
          <v-card-text>
            <b
              >Center for Air and Aquatic Resources Engineering and Sciences
              (CAARES)</b
            >
            of Clarkson University has operated this program since 2005, and we
            have modernized legacy pollutant measurements by developing
            efficient sample processing and analysis procedures. Improvements
            include lowering detection limits, adding additional chemicals to
            the analyte list, scanning for and identifying emerging contaminants
            and including the routine analyses of fish eggs. We have also
            enhanced the program by developing working relationships with
            laboratories from other federal agencies, states and countries.
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
